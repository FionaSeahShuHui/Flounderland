...
// Game Sound Effects
let correctGuess = new Audio("../hangman/audio/CorrectGuess.mp3");
let wrongGuess = new Audio("../hangman/audio/WrongGuess.mp3");
let gameOver = new Audio("../hangman/audio/GameOver.mp3");
let gameWin = new Audio("../hangman/audio/WinGame.mp3");
...
function keyBoardFunction(letter) {
  ...
  if (correctGuessCount <= 0) {
    ...
    document.getElementById("strikes").src =
      "../hangman/images/" + wrongGuessCount + ".png";
    wrongGuess.play();
  } else {
    correctGuessCount = 0;
  }
